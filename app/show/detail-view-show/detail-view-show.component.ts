...
@Component({
  selector: 'app-detail-view-show',
  templateUrl: './detail-view-show.component.html',
  styleUrls: ['./detail-view-show.component.css'],
})
export class DetailViewShowComponent implements OnInit {
  sh: Show;
  showId: number;
  movies: any[];
  mvee: Movie;
